...
export default function App() {
  return (
    <div className="min-h-screen bg-white text-gray-800 px-4 py-8 md:px-12 lg:px-24 font-sans">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-2">🍙 Onigiri San</h1>
        <p className="text-lg">Onigiris caseros en Jujuy, Argentina</p>
        <p className="text-md text-gray-600">
          Pedidos de lunes a jueves | Entregas viernes a domingo
        </p>
        <div className="flex justify-center gap-4 mt-4">
          <a
            href="https://www.instagram.com/onigiri_san_jujuy"
            target="_blank"
          ...
          <a
            href="https://wa.me/5493880000000"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <section className="mb-16">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[
            {
              title: "Combo Clásico",
              desc: "3 onigiris a elección + salsa de soja casera",
              price: "$3000",
            },
            {
              title: "Combo XL",
              desc: "5 onigiris + salsa + detalle sorpresa",
              price: "$4500",
            },
            {
              title: "Sorpresa San",
              desc: "3 onigiris sorpresa seleccionados por el chef",
              price: "$2800",
            },
          ].map((item, idx) => (
      ...
      <section className="text-center mb-20">
        ...
        <a
          href="https://forms.gle/ejemplo-formulario-onigiri"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-full text-lg px-6 py-3"
        >
          Hacer Pedido
        </a>
      </section>
